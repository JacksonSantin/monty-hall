...
**Monty Hall Problem** - Sexto projeto desenvolvido durante o curso **Curso Vue JS 2 - O Guia Completo (incl. Vue Router & Vuex)**.

Projeto consiste na criação do jogo Monty Hall Problem utilizando o framework Vue.js.
...
Consulte informações sobre a licença do projeto [MIT](https://github.com/JacksonSantin/monty-hall/blob/master/LICENSE).
